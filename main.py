...
if __name__ == "__main__":
    ...
    st.markdown("<h1 style='text-align: center; font-size: 15px; color: black;'>The 'CO2 Emission Predictor' mini-project is developed as an IIT Assignment</h1>", unsafe_allow_html=True)
