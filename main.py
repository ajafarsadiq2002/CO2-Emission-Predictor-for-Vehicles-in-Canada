...
if __name__ == "__main__":
    ...
    st.markdown("<h1 style='text-align: center; font-size: 40px; color: red;'>**Machine Learning Engineers :** Allabaksh S[G24AIT2164] and Jafar Sadiq[G24AIT2152]</h1>", unsafe_allow_html=True)
